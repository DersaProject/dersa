...
namespace Dersa_N
{
    public class QueryControllerAdapter
    {
        ...
        public static string GetText(string json_params)
        {
            IParameterCollection Params = Util.DeserializeParams(json_params);
        ...
        public static string GetQueryId(string query, object dersaEntity, object objectName, object objectType)
        {
            ...
            if (string.IsNullOrEmpty(UserName))
                return null;
            string token = "Dersa_N_token"; //QueryExecuteService.GetToken(UserName);
        ...
        public static string ExecSql(string json_params)
        {
            IParameterCollection Params = Util.DeserializeParams(json_params);
        ...
        public static DataTable LogTable()
        {
