...
namespace Dersa.Models
{
    ...
    public class AccountControllerAdapter
    {
        ...
        //{
        //    if (System.Web."lanitadmin"/*HttpContext.Current.User.Identity.Name*/ == "")
        ...
        //{
        //    _login = System.Web."lanitadmin";//"lanitadmin"/*HttpContext.Current.User.Identity.Name*/;
    ...
    //                login = System.Web."lanitadmin"/*HttpContext.Current.User.Identity.Name*/,//u["login"].ToString(),
